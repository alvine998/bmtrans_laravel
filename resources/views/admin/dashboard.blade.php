...
<div class="mt-6 grid grid-cols-2 lg:grid-cols-5 gap-4">
  ...
  <a href="{{ route('admin.testimonials.index') }}" class="bg-bm-cream-soft border border-bm-dark/10 p-5 hover:bg-bm-yellow/10"><div class="font-mono text-[11px] uppercase text-bm-gray-light">Testimoni</div><div class="font-display text-[28px]">{{ $stats['testimonials'] }}</div></a>
