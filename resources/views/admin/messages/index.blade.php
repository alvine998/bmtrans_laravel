...
<div class="mt-6 bg-bm-cream-soft border border-bm-dark/10 divide-y divide-bm-dark/5">
  @foreach($messages as $m)
    <a href="{{ route('admin.messages.show',$m) }}" class="block p-4 hover:bg-bm-dark/[0.02] flex justify-between">
