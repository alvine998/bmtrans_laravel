...
@php
  ...
  $variants = [
    ...
    'secondary' => 'border border-white/20 text-white px-6 py-3.5 hover:bg-white hover:text-bm-black',
    'yellow' => 'bg-bm-yellow text-bm-black px-6 py-3.5 hover:bg-bm-yellow-dark',
