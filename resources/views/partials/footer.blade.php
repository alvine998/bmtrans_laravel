...
<footer class="relative mt-24 bg-bm-dark border-t border-bm-dark text-bm-cream overflow-hidden">
  ...
  {{-- big watermark --}}
  <div class="pointer-events-none absolute -bottom-10 -right-10 font-display font-black text-[18vw] leading-none text-white/[0.04] uppercase select-none">BMTRANS</div>
  ...
  <div class="relative mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
    <div class="grid lg:grid-cols-[1.2fr_1fr_1fr_1fr] gap-10 lg:gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2 text-[14px] text-bm-cream/70">
          <li><a href="{{ route('about') }}" class="hover:text-bm-cream">Tentang Kami & Legalitas</a></li>
          <li><a href="{{ route('gallery') }}" class="hover:text-bm-cream">Galeri Armada & Gudang</a></li>
          <li><a href="{{ route('articles.index') }}" class="hover:text-bm-cream">Artikel & Insight</a></li>
          <li><a href="{{ route('contact') }}" class="hover:text-bm-cream">Hubungi & Cabang</a></li>
        </ul>
        <div class="mt-6 p-3 bg-bm-dark border border-bm-yellow/20">
      ...
      {{-- CTA --}}
      <div class="bg-bm-cream text-bm-dark border border-bm-dark/10 p-5">
        ...
        <div class="mt-4 flex gap-2 font-mono text-[10px]">
          ...
          <span class="px-2 py-1 bg-bm-dark/5">LAUT</span>
          <span class="px-2 py-1 bg-bm-dark/5">UDARA</span>
        </div>
      </div>
    </div>
  </div>

  <div class="border-t border-bm-dark/5">
    <div class="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 font-mono text-[10px] uppercase tracking-widest text-bm-gray-light">
      <div class="flex flex-wrap gap-4">
        <a href="/sitemap.xml" class="hover:text-bm-cream">Sitemap</a>
        <a href="/robots.txt" class="hover:text-bm-cream">Robots</a>
