...
class ArticleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $articles = [
            ...
            ['title' => 'Perbedaan LCL dan FCL dalam Pengiriman Kontainer', 'category_id' => $log, 'excerpt' => 'Kenali kapan harus memilih LCL dan kapan FCL lebih hemat untuk bisnis Anda.', 'body' => '<p>LCL (Less than Container Load) cocok untuk muatan kecil yang digabung dengan pengirim lain, sedangkan FCL (Full Container Load) digunakan saat volume muatan sudah memenuhi satu kontainer penuh.</p><p>Pemilihan yang tepat dapat menghemat biaya logistik hingga 30% tergantung volume pengiriman bulanan.</p>'],
